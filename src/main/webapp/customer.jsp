...
<body>
<a href="Customers.jsp" target="_blank">Customers</a>
	<a href="Vehicles.jsp" target="_blank">Vehicles</a>
	<a href="Drivers.jsp" target="_blank">Drivers</a>
	<a href="default.asp" target="_blank">Discounts</a>
	<a href="default.asp" target="_blank">Quote</a>
	<h3>
		<marquee>We need to ask you some personal information to
			provide you with an accurate quote.This information is kept private
			and secure and will not be sold</marquee>
	</h3>
...
<br/>
    ...
    <form:label  id="city" path="city">${customer.city}</form:label>
    <br/> 
    <label style="width: 50%" for="state"><b>State : </b></label>
    <form:label id="state" path="state">${customer.state}</form:label>
<br/>
